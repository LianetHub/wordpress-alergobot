...
$hero_query = alergobot_query_blogs(
	alergobot_get_blog_archive_base_query_args(
		$context,
		array(
			'posts_per_page' => 1,
		)
...
$recent_args = alergobot_get_blog_archive_base_query_args(
	$context,
	array(
		'posts_per_page' => 4,
	)
...
if ( $featured_id ) {
	$recent_args['post__not_in'] = array( $featured_id );
}
...
$current_page = 'news' === $active_tab ? $context['news_paged'] : $context['articles_paged'];

$articles_active = 'articles' === $active_tab;
$news_active     = 'news' === $active_tab;
