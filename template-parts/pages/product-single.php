...
?><section class="product-hero">
				<div class="product-hero__container _container">
					<div class="product-hero__card">
						<div class="product-hero__content">
							<h1 class="product-hero__title title title-lg title--light" data-animate="bottom"> Анализатор иммунологический <span class="text-nowrap">«Q-SMART»</span>
							</h1>
						...
						<div class="product-hero__visual" data-animate="bottom">
							<div class="product-hero__media">
								...
								<span class="product-hero__stock" data-animate="scale"> В наличии </span>
			...
			<section class="product-detail">
				<div class="product-detail__container _container">
					<div class="product-tabs" role="tablist" aria-label="Разделы товара">
						<button class="product-tabs__btn _active" type="button" role="tab" id="product-tab-description" aria-selected="true" aria-controls="product-panel-description" data-product-tab="description" data-animate="fade">
						...
						<button class="product-tabs__btn" type="button" role="tab" id="product-tab-ru" aria-selected="false" aria-controls="product-panel-ru" data-product-tab="ru" data-animate="fade">
						...
						<button class="product-tabs__btn" type="button" role="tab" id="product-tab-video" aria-selected="false" aria-controls="product-panel-video" data-product-tab="video" data-animate="fade">
						...
						<button class="product-tabs__btn" type="button" role="tab" id="product-tab-docs" aria-selected="false" aria-controls="product-panel-docs" data-product-tab="docs" data-animate="fade">
					...
					<div class="product-panels">
						<div class="product-panel _active" id="product-panel-description" role="tabpanel" aria-labelledby="product-tab-description" data-product-panel="description">
							<div class="product-panel__inner product-panel__inner--description">
								<p class="product-panel__lead" data-animate="bottom">Анализатор «Q-SMART» обеспечивает проведение лабораторных исследований методом иммунохемилюминесцентного анализа (ИХЛА), в основе которого лежат иммунные реакции антигена с антителом. Оборудование предназначено для считывания результатов анализов со всех типов панелей PROTIA Allergy-Q</p>
								<div class="product-block">
									<h2 class="product-block__title title title-md-sm" data-animate="bottom">Особенности работы иммунологического фотометрического анализатора «Q-SMART»</h2>
									<ul class="product-list">
										<li class="product-list__item" data-animate="bottom">Работает в паре с внешним компьютером с OC Windows (XP, 7, 10)</li>
										<li class="product-list__item" data-animate="bottom">Имеет полностью русифицированный интерфейс</li>
										<li class="product-list__item" data-animate="bottom">Разрешение при сканировании: 1200 х 1200 dpi</li>
										<li class="product-list__item" data-animate="bottom">Количество одновременно идентифицируемых панелей: 8</li>
										<li class="product-list__item" data-animate="bottom">Единицы измерений: МЕ/мл</li>
										<li class="product-list__item" data-animate="bottom">Количество определяемых аллерген-специфических IgE-антител: 0…2000.МЕ/мл</li>
										<li class="product-list__item" data-animate="bottom">Интерфейс для связи с компьютером: USB 2.0</li>
										<li class="product-list__item" data-animate="bottom">Напряжение питания через блок питания: 220B+-10%</li>
									</ul>
								</div>
								<div class="product-block">
									<h2 class="product-block__title title title-md-sm" data-animate="bottom">Комплектация поставки:</h2>
									<ul class="product-list">
										<li class="product-list__item" data-animate="bottom">аппарат анализатора Q-SMART</li>
										<li class="product-list__item" data-animate="bottom">блок питания MOD6A-181WP24</li>
										<li class="product-list__item" data-animate="bottom">USB-кабель</li>
										<li class="product-list__item" data-animate="bottom">USB-ключ</li>
										<li class="product-list__item" data-animate="bottom">поролоновый мат</li>
										<li class="product-list__item" data-animate="bottom">калибровочная карта</li>
										<li class="product-list__item" data-animate="bottom">выдвижной ящик</li>
										<li class="product-list__item" data-animate="bottom">руководство по эксплуатации</li>
									</ul>
								</div>
								<div class="product-block product-block--allergens">
									<h2 class="product-block__title title title-md-sm" data-animate="bottom">Аллергены</h2>
									<p class="product-block__text" data-animate="bottom">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<div class="product-table-wrap" data-product-table="" data-animate="bottom">
										<table class="product-table">
											...
											<tbody>
												...
												<tr>
													<td>5</td>
													<td>Альфа-лактоальбумин</td>
													<td>α-lactalbumin</td>
													<td>f76</td>
												</tr>
												<tr>
													<td>6</td>
													<td>Бета-лактоглобулин</td>
												...
												<tr>
													<td>19</td>
													<td>Морской моллюск</td>
													<td>Sea Clam</td>
													<td>f207</td>
												</tr>
												<tr>
													<td>20</td>
													<td>Куколка шелкопряда</td>
													<td>Silkworm pupa</td>
													<td>—</td>
												</tr>
												<tr>
												...
												<tr>
													<td>30</td>
													<td>Эпителий кошки и перхоть</td>
													<td>Cat epithelium and dandruff</td>
													<td>e1</td>
												</tr>
												<tr>
													<td>31</td>
												...
												<tr>
													<td>35</td>
													<td>D. Penicillium notatum</td>
													<td>Penicillium notatum</td>
													<td>m1</td>
												</tr>
												<tr>
													<td>36</td>
												...
												<tr>
													<td>38</td>
													<td>Смесь берёза-ольха</td>
													<td>Birch-alder mixture</td>
													<td>tx</td>
												</tr>
												<tr>
													<td>39</td>
												...
												<tr>
													<td>41</td>
													<td>Амброзия полыннолистная высокая</td>
											...
											<tfoot class="product-table__foot">
												<tr>
													<td></td>
													<td>
														<button class="product-table__more" type="button" data-product-table-more="" aria-expanded="false">ЕЩЕ</button>
													</td>
													<td></td>
													<td></td>
												</tr>
						...
						<div class="product-panel" id="product-panel-ru" role="tabpanel" aria-labelledby="product-tab-ru" data-product-panel="ru" hidden="">
							<div class="product-panel__inner product-panel__inner--ru">
								<h2 class="product-panel__heading" data-animate="bottom">Регистрационное удостоверение</h2>
								<dl class="product-spec">
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Регистрационный номер медицинского изделия</dt>
										<dd class="product-spec__value">РЗН 2021/14798</dd>
									</div>
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Дата государственной регистрации медицинского изделия</dt>
										<dd class="product-spec__value">14.07.2021</dd>
									</div>
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Наименование медицинского изделия</dt>
										<dd class="product-spec__value">Анализатор иммунологический фотометрический «Q-SMART» для диагностики ин витро на панелях «PROTIA» в составе: — анализатор Q-SMART; — блок питания MOD 6А-181WP24; — USB-кабель; — USB-ключ; — поролоновый мат; — калибровочная карта; — выдвижной ящик; — руководство по эксплуатации.</dd>
									</div>
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Наименование организации-производителя медицинского изделия</dt>
										<dd class="product-spec__value">ProteomeTech Inc.</dd>
									</div>
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Место нахождения организации-производителя медицинского изделия</dt>
										<dd class="product-spec__value">ProteomeTech Inc., A-702, 401, Yangcheon-ro, Gangseo-gu, Seoul 07528, Republic of Korea</dd>
									</div>
									<div class="product-spec__row" data-animate="bottom">
										<dt class="product-spec__term">Скачать РУ</dt>
										<dd class="product-spec__value"><a class="product-spec__link" href="#">РУ_Q-SMART.pdf</a></dd>
									</div>
								</dl>
							</div>
						</div>
						...
						<div class="product-panel" id="product-panel-docs" role="tabpanel" aria-labelledby="product-tab-docs" data-product-panel="docs" hidden="">
			...
			<section class="benefits">
				<div class="benefits__container _container">
					<header class="benefits__head">
						<h2 class="benefits__title title title-md" data-animate="bottom">Преимущества решений PROTIA</h2>
					</header>
					<div class="benefits__body">
						<div class="benefits__brand">
							<div class="benefits__text" data-animate="bottom">
								<p>
									<strong>PROTIA — южнокорейский производитель решений для in vitro diagnostics с фокусом на технологичность, точность и развитие современных диагностических систем.</strong>
								</p>
								<p> Бренд объединяет продуктовую экспертизу, собственные разработки и комплексный подход, в котором панели, оборудование и диагностическая логика работают как единая система. PROTIA развивает решения в сфере лабораторной диагностики и формирует продукты для применения в профессиональной медицинской среде. </p>
							</div>
						</div>
						<div class="benefits__grid">
							<article class="benefits__card" data-animate="bottom">
								...
								<h3 class="benefits__card-title">Профессиональная специализация в IVD</h3>
							</article>
							<article class="benefits__card" data-animate="bottom">
								<div class="benefits__card-head">
								...
								<h3 class="benefits__card-title">Признание на международном уровне</h3>
							</article>
							<article class="benefits__card" data-animate="bottom">
								<div class="benefits__card-head">
								...
								<h3 class="benefits__card-title">Технологичный подход к аллергодиагностике</h3>
							</article>
							<article class="benefits__card" data-animate="bottom">
								<div class="benefits__card-head">
				...
				<div class="equipment__container _container">
					<div class="equipment__head">
						<div class="equipment__intro">
							<h2 class="equipment__title title title-md" data-animate="bottom">Вместе с&nbsp;этим смотрят</h2>
						</div>
