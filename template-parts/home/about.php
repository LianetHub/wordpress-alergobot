			...
			<div class="about__main">
				...
				<?php if ( alergobot_home_rows( 'photos' ) ) : ?>
					<div class="about__photos">
						<?php
						foreach ( alergobot_home_rows( 'photos' ) as $photo ) :
			...
			<div class="about__aside">
				...
				<?php if ( alergobot_home_rows( 'body_paragraphs' ) ) : ?>
					<div class="about__body">
						<?php
						foreach ( alergobot_home_rows( 'body_paragraphs' ) as $paragraph_index => $paragraph ) :
							$anim_type = 0 === $paragraph_index % 2 ? 'fade-left' : 'fade-right';
							?>
